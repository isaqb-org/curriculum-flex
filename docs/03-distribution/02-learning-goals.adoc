...
* Software understand understand the tradeoffs of request/response communication vs. fire-and-forget.
...
* Software architects know languages for interfaces in distributed systems such as WSDL, GraphQL schema, and OpenAPI.
...
* Software architects understand how difficult ACID is to achieve in a distributed setting.
...
* Software architects understand the tradeoffs of using common modules across organizational units and "shared nothing" strategies.
