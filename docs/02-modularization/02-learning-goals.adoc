...
.What should participants know?
* The participants should know various technical mechanisms to subdivide a
  system at development time: source code files, JARs, OSGi bundles,
  modules of the programming language
* The participants should know various means of subdividing a system
  at run time: processes, microservices, self-contained systems.
