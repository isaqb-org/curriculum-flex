...
* Architects can use modularization to map conceptual building blocks into (technical) modules.
...
* Architects understand the need to decompose a system into coarse-grained building blocks before modules exist.

* Architects can draft a coarse-grained building-block decomposition for a system top-down according to known requirements.
...
* Architects know non-linguistic approaches to enforcing modularization such as creating unit tests that operate on the module dependency graph.
